...
\definecolor{xmlred}{rgb}{255,0,0}
...
\lstdefinelanguage{csharp}{
	...
	LoggingCategories,
	LoggedException,
	GettingItemPropertyValuesWebDAV,
	STAThread,
	Stream,
	Encoding,
	Console	
...
\lstdefinelanguage{config}{
   ...
   basicstyle=\fontsize{9}{11}\ttfamily,
    ...
    basicstyle =\color{redstrings},
    morekeywords = {xml, configuration, appSettings, add, startup, supportedRuntime, runtime, assemblyBinding, dependentAssembly, assemblyIdentity, bindingRedirect},
    emph =[1]
    {
	version,
	encoding,
...
\input{poglavlja/ch_zakljucak.tex}
\input{poglavlja/ch_literatura.tex}
\input{poglavlja/ch_obrazac.tex}
%
% Koriscenje listinga
%
